...
case class Mayiner(C: Double, Mn: Double, Ni: Double, Cr: Double, Mo: Double, S: Double, V: Double, aT: Double, at: Double, tT: Double, tt: Double) {
  ...
  val transitPoints: Seq[Double] = {
    ...
    def m100: Double = pow(10, 9.81 - ((4.62 * C) + (1.05 * Mn) + (0.54 * Ni) + (0.5 * Cr) + (0.66 * Mo) + (0.00183 * Pa(aT, at))))

    def m90: Double = pow(10, 8.76 - ((4.04 * C) + (0.96 * Mn) + (0.49 * Ni) + (0.58 * Cr) + (0.97 * Mo) + (0.001 * Pa(aT, at))))

    def m50: Double = pow(10, 8.50 - ((4.12 * C) + (0.86 * Mn) + (0.57 * Ni) + (0.41 * Cr) + (0.94 * Mo) + (0.0012 * Pa(aT, at))))


    def b100: Double = pow(10, 10.17 - ((3.8 * C) + (1.07 * Mn) + (0.7 * Ni) + (0.57 * Cr) + (1.58 * Mo) + (0.0032 * Pa(aT, at))))

    def b90: Double = pow(10, 10.55 - ((3.65 * C) + (1.08 * Mn) + (0.77 * Ni) + (0.61 * Cr) + (1.49 * Mo) + (0.004 * Pa(aT, at))))

    def b50: Double = pow(10, 8.74 - ((2.23 * C) + (0.86 * Mn) + (0.56 * Ni) + (0.59 * Cr) + (1.6 * Mo) + (0.0032 * Pa(aT, at))))


    def fp90: Double = pow(10, 7.51 - ((1.38 * C) + (0.35 * Mn) + (0.93 * Ni) + (0.11 * Cr) + (2.31 * Mo) + (0.0033 * Pa(aT, at))))

    def fp50: Double = pow(10, 6.36 - ((0.43 * C) + (0.49 * Mn) + (0.78 * Ni) + (0.27 * Cr) + (0.38 * Mo) + (2 * sqrt(Mo)) + (0.0019 * Pa(aT, at))))
  ...
  def temperingHardness(Vr: Double): Double = {
    val structure = findStructure(Vr)
    (martensiteTempering * structure._1) +
      (bainiteTempering * structure._2) +
      (perliteFerriteQuenching(Vr) * structure._3)
  }
